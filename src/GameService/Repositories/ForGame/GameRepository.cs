...
public class GameRepository : IGameRepository
{
    ...
    public GameRepository(GameDatabaseContext context,IMapper mapper,IFileService fileService,BaseResponseModel responseModel,IPublishEndpoint publishEndpoint)
    {
